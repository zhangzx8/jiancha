...
+function($) {
	...
	$(document).on('click.bs.dropdown.data-api', clearMenus).on(
			...
			Dropdown.prototype.keydown).on('keydown.bs.dropdown.data-api',
...
+function($) {
	...
	Tooltip.prototype.replaceArrow = function(delta, dimension, isHorizontal) {
		this.arrow().css(isHorizontal ? 'left' : 'top',
...
+function($) {
	...
	$.fn.typeahead = function(option) {
		...
		source: [],
		items: 8,
		menu: '<ul class="typeahead dropdown-menu customSty"></ul>',
		item: '<li><a href="#"></a></li>',
		minLength: 1
