...
$.fn.idealTabs = function (container) {
  ...
  //$wrapper = $('<div class="nav-tabs-custom"/>'),
      $tabs = (function () {
        var tabs = []
  ...
  $.fn.idealFile = function() {
    ...
    return this.each(function() {
      ...
      var $file = $(this).addClass('ideal-file'), // the original file input
          ...
          $button = $('<button type="button" class="btn btn-success">Open</button>'),
          // Hack for IE
...
var getFilters = function() {
  ...
  var filters = {
    ...
    ghname: {
      regex: /^[a-z](?=[\w.]{3,31}$)\w*\.?\w*$/i,
      error: $.idealforms.errors.ghname
    },
...
$.extend( IdealForms.prototype, {
  ...
  _adjust: function() {
    ...
    labels.removeAttr('style').width( Utils.getMaxWidth( labels )+50)
