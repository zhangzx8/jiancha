...
<div class="z_right">
<div class="z_title"><div class="title_left"><img src="/resource/images/index_title_zhin.jpg" /></div><div class="title_right"><a href="zp.html"><input type="button" name="dy" value="查看留言"  style="width:60px;height:30px;"/></a></div></div>
<div class="z_list">
